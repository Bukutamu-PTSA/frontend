...
import { r as Route$9 } from "./router-D_q8IFgo.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/edit_user-DZGoM4QQ.js
...
function EditUserPage() {
	...
	const [nama, setNama] = (0, import_react.useState)("Budi Santoso");
	const [email, setEmail] = (0, import_react.useState)("budi.santoso@kemnaker.go.id");
